 ...
 * @author Asus
 */
public class ViewLihatBuku extends javax.swing.JFrame {

    /**
     * Creates new form ViewLihatBuku
     */
    public ViewLihatBuku() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(8, 69, 69), 5));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewLihatBuku.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewLihatBuku().setVisible(true);
            }
        });
    }
    ...
    public JTable getTabDataBuku() {
        return TabDataBuku;
    }
    
    public void setTabDataAT(DefaultTableModel tabDataAT) {
        this.TabDataBuku.setModel(tabDataAT);
    }
